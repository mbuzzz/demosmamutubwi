          ...
          <button
            ...
            className={`px-6 py-4 text-sm font-medium whitespace-nowrap border-b-2 transition-colors ${
              activeTab === 'mengajar' 
                ...
                : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-200 hover:border-slate-300'
            }`}
          >
            Penugasan Mengajar
          </button>
                ...
                <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap gap-1">
                      <span className="px-2 py-0.5 bg-slate-100 rounded text-xs">X-1</span>
                      <span className="px-2 py-0.5 bg-slate-100 rounded text-xs">X-2</span>
                      <span className="px-2 py-0.5 bg-slate-100 rounded text-xs">XI-IPA-1</span>
                    </div>
                  </td>
            ...
            <table className="w-full text-left text-sm text-slate-600 dark:text-slate-300">
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <td className="px-6 py-4 text-slate-700 dark:text-slate-200">Waka Kurikulum</td>
                  <td className="px-6 py-4">
