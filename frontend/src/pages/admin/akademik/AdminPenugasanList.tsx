        ...
        {activeTab === 'mengajar' ? (
            ...
            <table className="w-full text-left text-sm text-slate-600">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50">
                  <td className="px-6 py-4 font-medium text-slate-800">Ahmad Hidayat, S.Pd</td>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm text-slate-600">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50">
                  <td className="px-6 py-4 font-medium text-slate-800">Drs. H. Sugeng, M.Pd</td>
                ...
                <tr className="hover:bg-slate-50">
                  <td className="px-6 py-4 font-medium text-slate-800">Budi Santoso, S.Kom</td>
                  <td className="px-6 py-4 text-slate-700">Waka Kurikulum</td>
                  <td className="px-6 py-4">
