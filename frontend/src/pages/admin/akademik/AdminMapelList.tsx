          ...
          <table className="w-full text-left text-sm text-slate-600">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                <td className="px-6 py-4 font-bold text-slate-800">MAT-W</td>
                <td className="px-6 py-4 font-medium text-slate-800">Matematika Wajib</td>
              ...
              <tr className="hover:bg-slate-50">
                <td className="px-6 py-4 font-bold text-slate-800">FIS-P</td>
