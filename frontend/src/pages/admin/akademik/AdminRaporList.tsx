            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-right">
                  <Link to="/panel/rapor/cetak/1" className="inline-block p-1.5 text-slate-400 hover:text-indigo-600" title="Cetak Individu"><Printer className="w-4 h-4" /></Link>
                </td>
              </tr>
              <tr className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-right">
                  <Link to="/panel/rapor/cetak/2" className="inline-block p-1.5 text-slate-400 hover:text-indigo-600" title="Cetak Individu"><Printer className="w-4 h-4" /></Link>
                </td>
              </tr>
            </tbody>
          </table>
