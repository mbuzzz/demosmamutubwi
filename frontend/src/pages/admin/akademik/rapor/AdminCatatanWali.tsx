        ...
        <div className="p-6 grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-1 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden bg-white dark:bg-slate-900 flex flex-col h-[600px]">
            ...
            <div className="flex-1 overflow-y-auto divide-y divide-slate-100 custom-scrollbar">
              ...
              <button className="w-full text-left p-4 hover:bg-slate-50 dark:bg-slate-800/50 transition-colors border-l-4 border-transparent">
                <div className="font-semibold text-slate-700 dark:text-slate-200 text-sm">Budi Raharjo</div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">NISN: 0081234502</div>
              </button>
              <button className="w-full text-left p-4 hover:bg-slate-50 dark:bg-slate-800/50 transition-colors border-l-4 border-transparent">
                <div className="font-semibold text-slate-700 dark:text-slate-200 text-sm">Citra Kirana</div>
          ...
          <div className="xl:col-span-3 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border border-slate-200 dark:border-slate-700 space-y-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Sikap Spiritual</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Sikap Sosial</label>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-3">
                      <input type="text" defaultValue="Pramuka (Wajib)" className="w-1/2 px-3 py-1.5 bg-slate-100 border border-slate-200 dark:border-slate-700 rounded text-sm text-slate-500 dark:text-slate-400" readOnly />
                    ...
                    <div className="flex gap-3">
                      <input type="text" defaultValue="Tapak Suci" className="w-1/2 px-3 py-1.5 bg-slate-100 border border-slate-200 dark:border-slate-700 rounded text-sm text-slate-500 dark:text-slate-400" readOnly />
                      <select className="w-1/2 px-3 py-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded text-sm font-bold text-indigo-600 outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800 mb-2">
                    <span className="text-sm font-semibold text-slate-600 dark:text-slate-300">Sakit</span>
                  ...
                  <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800 mb-2">
                    <span className="text-sm font-semibold text-slate-600 dark:text-slate-300">Izin</span>
                  ...
                  <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800">
                    <span className="text-sm font-semibold text-slate-600 dark:text-slate-300">Tanpa Keterangan (Alpa)</span>
