          ...
          <table className="w-full text-left text-sm text-slate-600 dark:text-slate-300">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                ...
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 bg-slate-100 text-slate-600 dark:text-slate-300 rounded-md text-xs font-medium border border-slate-200 dark:border-slate-700 w-fit block">Tidak Aktif</span>
                </td>
