          ...
          <table className="w-full text-left text-sm text-slate-600">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                <td className="px-6 py-4 font-medium text-slate-800">Kurikulum Merdeka</td>
              ...
              <tr className="hover:bg-slate-50">
                <td className="px-6 py-4 font-medium text-slate-800">Kurikulum 2013 (K13)</td>
                <td className="px-6 py-4">2013/2014</td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 bg-slate-100 text-slate-600 rounded-md text-xs font-medium border border-slate-200 w-fit block">Tidak Aktif</span>
                </td>
