    ...
    <AdminLayout title="Pengaturan Halaman Beranda">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[15px] shadow-card p-6 border border-slate-100 dark:border-slate-800">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Headline Utama</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Sub-headline (Deskripsi Pendek)</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Teks Tombol Utama (CTA)</label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Link Tautan Tombol</label>
            ...
            <div className="space-y-3">
              {[1, 2, 3].map((item) => (
                <div key={item} className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl border border-slate-200 dark:border-slate-700">
                  <div className="font-bold text-slate-400 dark:text-slate-500 w-6">{item}.</div>
                  <select className="flex-1 px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 font-medium text-slate-700 dark:text-slate-200">
                  ...
                  <button className="p-2 text-slate-400 dark:text-slate-500 hover:text-red-500 hover:bg-red-50 rounded-lg"><Trash2 className="w-4 h-4" /></button>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="xl:col-span-1 space-y-6">
              ...
              {stats.map((s) => (
                <div key={s.id} className="group flex items-center gap-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 rounded-xl hover:border-indigo-400 transition-colors">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <input type="text" defaultValue={s.label} className="w-full px-2 py-1 bg-slate-50 dark:bg-slate-800/50 border border-transparent hover:border-slate-200 dark:border-slate-700 focus:border-indigo-500 rounded text-xs text-slate-600 dark:text-slate-300 focus:outline-none" placeholder="Label" />
                  </div>
                  <button className="opacity-0 group-hover:opacity-100 p-1.5 text-slate-400 dark:text-slate-500 hover:text-red-500 transition-opacity"><Trash2 className="w-4 h-4" /></button>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[15px] shadow-card p-6 border border-slate-100 dark:border-slate-800 sticky top-24">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300 mb-6">Pastikan semua data sudah benar sebelum menyimpan. Perubahan akan langsung terlihat di website publik.</p>
