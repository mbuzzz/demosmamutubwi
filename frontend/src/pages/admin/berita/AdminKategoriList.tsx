        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 items-start">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl p-5">
            ...
            <form className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Nama Kategori</label>
              ...
              <table className="w-full text-left text-sm text-slate-600 dark:text-slate-300">
                ...
                <tbody className="divide-y divide-slate-100 bg-white dark:bg-slate-900">
                  <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <td className="px-6 py-4"><span className="px-2 py-1 bg-slate-100 text-slate-600 dark:text-slate-300 rounded-md font-medium">12 Artikel</span></td>
                  ...
                  <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <td className="px-6 py-4"><span className="px-2 py-1 bg-slate-100 text-slate-600 dark:text-slate-300 rounded-md font-medium">5 Artikel</span></td>
                    <td className="px-6 py-4 text-right">
                      <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-indigo-600"><Edit className="w-4 h-4" /></button>
                      <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-red-600"><Trash2 className="w-4 h-4" /></button>
                    </td>
                  ...
                  <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <td className="px-6 py-4"><span className="px-2 py-1 bg-slate-100 text-slate-600 dark:text-slate-300 rounded-md font-medium">8 Artikel</span></td>
                    <td className="px-6 py-4 text-right">
                      <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-indigo-600"><Edit className="w-4 h-4" /></button>
                      <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-red-600"><Trash2 className="w-4 h-4" /></button>
                    </td>
