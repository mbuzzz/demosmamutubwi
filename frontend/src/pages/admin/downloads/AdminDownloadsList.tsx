              ...
              <tr className="hover:bg-slate-50">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="font-medium text-slate-800">Kalender Akademik 2024/2025</div>
                  </div>
                </td>
                <td className="px-6 py-4">Akademik</td>
                <td className="px-6 py-4 text-xs">1.2 MB (PDF)</td>
                <td className="px-6 py-4 text-right">
                  <button className="p-1.5 text-slate-400 hover:text-emerald-600 mr-1" title="Download"><Download className="w-4 h-4" /></button>
                  <button className="p-1.5 text-slate-400 hover:text-indigo-600 mr-1"><Edit className="w-4 h-4" /></button>
              ...
              <tr className="hover:bg-slate-50">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="font-medium text-slate-800">Brosur PPDB 2024</div>
                  </div>
                </td>
