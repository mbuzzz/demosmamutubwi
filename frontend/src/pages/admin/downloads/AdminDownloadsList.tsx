            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                ...
                <td className="px-6 py-4 text-right">
                  <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-emerald-600 mr-1" title="Download"><Download className="w-4 h-4" /></button>
                  <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-indigo-600 mr-1"><Edit className="w-4 h-4" /></button>
