...
export default function AdminRekapAbsensi() {
  ...
  const handleExportExcel = () => {
    ...
    const sheetName = 'Presensi RFID Gerbang';
    ...
    XLSX.writeFile(wb, `Rekap_Kehadiran_Gerbang_SIT.xlsx`);
    toast.success(`Rekap absensi Gerbang (RFID) berhasil diekspor ke Excel`);
  };
