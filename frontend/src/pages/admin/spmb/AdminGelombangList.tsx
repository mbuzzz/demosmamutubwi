  ...
  return (
    <AdminLayout title="Pengaturan Gelombang SPMB">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
        ...
        {/* Table View */}
        <div className={`bg-white dark:bg-slate-900 rounded-[15px] shadow-card overflow-hidden border border-slate-100 dark:border-slate-800 ${showForm ? 'xl:col-span-2' : 'xl:col-span-3'}`}>
            ...
            <table className="w-full text-left text-sm text-slate-600 dark:text-slate-300">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <td className="px-6 py-4 text-xs font-medium text-slate-600 dark:text-slate-300">1 Jan 2024<br/>s/d 28 Feb 2024</td>
                  ...
                  <td className="px-6 py-4 text-right">
                    ...
                    <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-red-600"><Trash2 className="w-4 h-4" /></button>
                  </td>
                </tr>
                <tr className="hover:bg-slate-50 dark:bg-slate-800/50 opacity-60">
                  <td className="px-6 py-4 font-bold text-slate-800 dark:text-white">Gelombang 1 Reguler</td>
                  <td className="px-6 py-4 text-xs font-medium text-slate-600 dark:text-slate-300">1 Mar 2024<br/>s/d 30 Apr 2024</td>
                  <td className="px-6 py-4">
                    <div className="w-full bg-slate-200 rounded-full h-2 mt-1 max-w-[120px]">
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 bg-slate-100 text-slate-600 dark:text-slate-300 rounded-md text-xs font-medium border border-slate-200 dark:border-slate-700">Menunggu Jadwal</span>
                  </td>
                  <td className="px-6 py-4 text-right">
                    <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-indigo-600"><Edit className="w-4 h-4" /></button>
                  </td>
        ...
        {showForm && (
          <div className="bg-white dark:bg-slate-900 rounded-[15px] shadow-card border border-slate-100 dark:border-slate-800">
            <div className="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
              <h3 className="font-bold text-slate-800 dark:text-white">Tambah Gelombang Baru</h3>
              <button onClick={() => setShowForm(false)} className="text-slate-400 dark:text-slate-500 hover:text-red-500 transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
