  ...
  return (
    <AdminLayout title="Buku Nilai Harian (Spreadsheet)">
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        ...
        <button className="flex-1 min-w-[200px] bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-indigo-400 dark:hover:border-indigo-500 text-left transition-all group">
          ...
          <p className="text-sm font-medium text-slate-500 mt-1">30 Siswa</p>
        </button>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm overflow-hidden border border-slate-100 dark:border-slate-800">
        ...
        <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/30">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1 flex items-center gap-1.5"><Keyboard className="w-3.5 h-3.5"/> Gunakan tombol <kbd className="px-1.5 bg-slate-200 dark:bg-slate-700 rounded text-[10px] mx-1">Tab</kbd> atau <kbd className="px-1.5 bg-slate-200 dark:bg-slate-700 rounded text-[10px] mx-1">Enter</kbd> untuk pindah kolom cepat.</p>
          </div>
          <div className="flex gap-3">
            <button className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-sm active:scale-95">
        ...
        <div className="overflow-x-auto p-6">
          <table className="w-full text-left text-sm border-collapse border border-slate-200 dark:border-slate-700">
            <thead className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-bold uppercase tracking-wider">
              <tr>
                ...
                <th className="p-3 border border-slate-200 dark:border-slate-700 min-w-[120px] text-center bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300">Tugas 1 (Eksponen)</th>
                <th className="p-3 border border-slate-200 dark:border-slate-700 min-w-[120px] text-center bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300">Tugas 2 (Logaritma)</th>
