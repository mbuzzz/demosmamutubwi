            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input type="datetime-local" className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-amber-500 text-slate-700 dark:text-white" />
                </div>
                ...
                <div className="pt-2">
                  <label className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 cursor-pointer">
                    <input type="checkbox" defaultChecked className="w-4 h-4 text-amber-500 focus:ring-amber-500 rounded border-slate-300" />
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm overflow-hidden border border-slate-100 dark:border-slate-800">
        <div className="p-6 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex justify-between items-center">
          ...
          <div className="relative max-w-sm w-64 hidden md:block">
            ...
            <input type="text" placeholder="Cari judul tugas..." className="w-full pl-9 pr-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 font-medium dark:text-white" />
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {/* Card Tugas Aktif */}
            <div className="flex items-start gap-4 p-5 border-2 border-amber-200 dark:border-amber-500/30 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group bg-amber-50/30 dark:bg-amber-500/5">
            ...
            {/* Card Tugas Selesai */}
            <div className="flex items-start gap-4 p-5 border border-slate-200 dark:border-slate-700 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group bg-white dark:bg-slate-900 opacity-70 hover:opacity-100">
